...
-- The server connects with the service-role key; make sure it can reach the
-- tables regardless of who ran this script (e.g. local CLI migrations run as
-- postgres without Supabase's default-privilege grants).
